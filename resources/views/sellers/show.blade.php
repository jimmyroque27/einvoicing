...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
                ...
                @if(Auth::user()->seller_id != $seller->user_id)
                    {{-- Seller Information --}}
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 mb-3 mb-sm-0">
                            ...
                            <span class="form-control mt-n3" > {{  $seller->RegNm }} </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 mb-3 mb-sm-0">
                            ...
                            <span class="form-control mt-n3" > {{  $seller->BusinessNm }} </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4 mb-3 mb-sm-0">
                            ...
                            <span class="form-control mt-n3" > {{  $seller->Tin }} </span>
                        ...
                        <div class="col-sm-4 mb-3 mb-sm-0">
                            ...
                            <span class="form-control mt-n3" > {{  $seller->BranchCd }} </span>
                        ...
                        <div class="col-sm-4 mb-3 mb-sm-0">
                            ...
                            <span class="form-control mt-n3" > {{  $seller->Type }} </span>
                    ...
                    <div class="form-group row">                        
                        ...
                        <div class="col-sm-12 mb-3 mb-sm-0">
                            ...
                            <span class="form-control mt-n3" > {{  $seller->Email }} </span>
                    ...
                    <div class="form-group row">                        
                        ...
                        <div class="col-sm-12 mb-3 mb-sm-0">
                            ...
                            <span class="form-control mt-n3" > {{  $seller->RegAddr }} </span>
