...
class ContactsDataTable extends DataTable
{
    ...
    protected function getActionColumn($data): string
    {
        ...
        if(Auth::user()->can('contact-show')){
            $showUrl ="<a class='waves-effect btn btn-success' title='show' data-value='$data->id' href='".route('contacts.show', $data->id)."'><i class='fas fa-fw fa-eye'></i></a> ";
        }
        $editUrl ="";
        if(Auth::user()->can('contact-edit')){
            $editUrl = "<a class='waves-effect btn btn-primary'  title='edit' data-value='$data->id' href='".route('contacts.edit', $data->id)."'><i class='fas fa-fw fa-pen'></i></a>";
        }
        $deleteUrl ="";
        if(Auth::user()->can('contact-delete')){
            $deleteUrl ="<a class='waves-effect btn deepPink-bgcolor delete'  title='delete' data-value='$data->id' href='".route('contacts.destroy', $data->id)."'><i class='fas fa-fw fa-trash'></i></a>";
        }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('company_id')->title("Company ID"),
            Column::make('registered_name')->title("Contact's Name"),
